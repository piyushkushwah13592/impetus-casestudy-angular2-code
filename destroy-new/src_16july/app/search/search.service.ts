...
export class SearchService {
    ...
    S_getCitiesForDeletion() {
        return this._http.get('http://localhost:8080/mymovieportal/city/getCitiesForDeletion').map(
