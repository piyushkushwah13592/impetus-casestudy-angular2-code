...
@Component({
    ...
    styleUrls: ['../userpersonal/userpersonal.component.css', '../login/css/style.css'],
    providers: [DatePipe, UserPersonalService, RegistrationService, LoginService, AuthenticationService, SearchService]
})
export class UserPersonalComponent implements OnInit {
    ...
    searchComponentObj: SearchCityComponent;
    ...
    constructor(private _userPersonalService: UserPersonalService, private _loginService: LoginService, private _formBuilder: FormBuilder,
        ...
        private _authenticationService: AuthenticationService, private dialog: MatDialog, private _searchService: SearchService,
    ...
    ngOnInit() {
        ...
        this.searchComponentObj = new SearchCityComponent(this._searchService, this._router, this._activatedRouter, this._datepipe, this._authenticationService, this.dialog, this._formBuilder);
    }
    ...
    // getUserHistory() {
    //   this.searchComponentObj.getUserHistory();
    //}

    backToSearch() {
        this._router.navigate(['/searchCity', this.id], { skipLocationChange: true });
    }
}
