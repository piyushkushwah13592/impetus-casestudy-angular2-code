...
@Component({
    ...
    styleUrls: ['../registration/registration.component.css', '../login/css/style.css'],
                                        ...
                                        resData => {
                                            ...
                                            if (this.flag) {
                                                const dialogRef = this.dialog.open(DialogOverviewExampleDialogComponent, {
                                                    width: '500px',
                                                    data: { name: 'You have successfully registered' }
                                                });
                                                //   alert('Signup Successfully');
                                                this._router.navigate(['/loginUser'], { skipLocationChange: true });
                                            }
